...
static wchar_t ORACLE_SNAPSHOT_ENGINE_FILENAME[] = L"snapshotOracleEngine.???";
static wchar_t ORACLE_SNAPSHOT_QUERY_METADATA_FILENAME[] = L"snapshotOracleQueryMetadata.???";
static wchar_t ORACLE_SNAPSHOT_QUERY_DATA_FILENAME[] = L"snapshotOracleQueryData.???";
static wchar_t ORACLE_SNAPSHOT_REPLY_STATES_FILENAME[] = L"snapshotOracleReplyStates.???";
static wchar_t ORACLE_SNAPSHOT_SUBSCRIPTIONS_FILENAME[] = L"snapshotOracleSubscriptions.???";
static wchar_t ORACLE_SNAPSHOT_SUBSCRIBERS_FILENAME[] = L"snapshotOracleSubscribers.???";
